                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        <div class="border rounded p-4">
                                            <div class="mb-4">
                                                <h4 class="mb-0">{{ translate('Icon') }}
                                                </h4>
                                            </div>
                                            <div class="text-center">
                                                <div class="upload-file_custom ratio-3-1 h-100px mx-auto">
                                                    <input type="file" name="logo" id="mail-icon"
                                                    ...
                                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                                        ...
                                                        <img class="upload-file-img" loading="lazy" src="{{isset($data) && $data['icon'] ? asset('storage/app/public/email_template/'.$data['icon']) : asset('public/assets/admin/img/icons/upload_img2.png')}}"
