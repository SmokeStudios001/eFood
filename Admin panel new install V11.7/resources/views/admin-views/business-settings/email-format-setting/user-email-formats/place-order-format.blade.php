                                ...
                                <div class="right-content">
                                    ...
                                    <div>
                                        ...
                                        <div class="border rounded p-4">
                                            <div class="mb-4">
                                                <h4 class="mb-0">{{ translate('logo') }}
                                                </h4>
                                            </div>
                                            <div class="text-center">
                                                <div class="upload-file_custom ratio-3-1 h-100px mx-auto">
                                                    <input type="file" name="logo" id="mail-logo"
                                                    ...
                                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                                        ...
                                                        <img class="upload-file-img" loading="lazy" src="{{isset($data) && $data['logo'] ? asset('storage/app/public/email_template/'.$data['logo']) : asset('public/assets/admin/img/icons/upload_img2.png')}}"
                                            ...
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="465" id="viewer"
                                                         src="{{isset($data) && $data['logo'] ? asset('storage/app/public/email_template/'.$data['logo']) : asset('public/assets/admin/img/icons/upload_img2.png')}}"
