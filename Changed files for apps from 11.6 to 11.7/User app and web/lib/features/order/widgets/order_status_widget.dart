...
class _StatusWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isDesktop = ResponsiveHelper.isDesktop(context);
    final bool isOrderStatusFinal = orderModel?.orderStatus == 'delivered' || 
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
      ...
      Expanded(flex: 8, child: Column(crossAxisAlignment: (isDesktop || isOrderStatusFinal) ? CrossAxisAlignment.center : CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
        Text(
        ...
        if(!isOrderStatusFinal) RichText(text: TextSpan(
