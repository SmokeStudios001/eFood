...
class OnlySocialLoginWidget extends StatefulWidget {
  ...
  const OnlySocialLoginWidget({super.key, this.redirectRoute});
...
class _OnlySocialLoginWidgetState extends State<OnlySocialLoginWidget> {
  ...
  void route(bool isRoute, String? token, String errorMessage, String? tempToken, UserInfoModel? userInfoModel, String? socialLoginMedium) async {
    ...
    if (isRoute) {
      if(token != null){
        // Successful login - redirect to original route or main
        ...
        ResponsiveHelper.showDialogOrBottomSheet(
          ...
          CustomAlertDialogWidget(
            ...
            child: ExistingAccountBottomSheet(userInfoModel: userInfoModel, loginMedium: socialLoginMedium!, redirectRoute: widget.redirectRoute),
          ),
        );
      }
      else {
