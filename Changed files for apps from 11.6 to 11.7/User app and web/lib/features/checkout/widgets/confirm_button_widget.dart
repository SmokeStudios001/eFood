              ...
              if(!takeAway && ( deliveryAddress == null || deliveryAddress.contactPersonNumber == null || deliveryAddress.address == null)) {
                ...
                if(!authProvider.isLoggedIn() || (locationProvider.addressList != null && locationProvider.addressList!.isEmpty)){
                  ...
                  RouterHelper.getAddAddressRoute(
                    page: 'checkout',
                    action: deliveryAddress == null ? 'add' :'update',
                ...
                if(checkoutProvider.selectedPaymentMethod != null || checkoutProvider.selectedOfflineValue != null){
                  ...
                  if(orderAmount < configModel.minimumOrderValue!) {
                    ...
                    final PlaceOrderBody placeOrderBody = PlaceOrderBody(
                      ...
                      paymentInfo: checkoutProvider.selectedOfflineValue != null
                          ? OfflinePaymentInfo(
                        methodFields: CheckOutHelper.getOfflineMethodJson(
                          checkoutProvider.selectedOfflineMethod?.methodFields,
                        ),
                        ...
                        paymentNote: checkoutProvider.selectedOfflineMethod?.paymentNote,
                          ...
                          : null,
                      deliveryTime: (checkoutProvider.selectTimeSlot == 0 && checkoutProvider.selectDateSlot == 0)
                          ? 'now' : DateFormat('HH:mm').format(scheduleStartDate),
                      isPartial: checkoutProvider.partialAmount == null ? '0' : '1' ,
                      isCutleryRequired: '${isCutlery ? 1 : 0}',
                      selectedDeliveryArea: locationProvider.selectedAreaID == -1
                          || checkoutProvider.orderType == OrderType.takeAway? null
                          : locationProvider.selectedAreaID,
                      ...
                      callBack: ResponsiveHelper.isWeb()
                          ? '$protocol//$hostname${kDebugMode ? ':$port' : ''}${RouterHelper.orderWebPayment}'
                    ...
                    if(placeOrderBody.paymentMethod == 'wallet_payment'
                      ...
                      final String? selectedUrl = await orderProvider.placeDigitalOrder(
                        context,
                        placeOrderBody,
                      );
