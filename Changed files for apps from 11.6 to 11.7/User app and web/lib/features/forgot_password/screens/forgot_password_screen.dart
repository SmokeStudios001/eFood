...
class ForgotPasswordScreen extends StatefulWidget {
  ...
  const ForgotPasswordScreen({super.key, this.redirectRoute});
                                ...
                                !auth.isForgotPasswordLoading && !auth.isPhoneNumberVerificationButtonLoading ? CustomButtonWidget(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_userInputController!.text.isEmpty) {
                                      ...
                                      ResponseModel? response =  await auth.forgetPassword(config: configModel, phoneOrEmail: userInput, type: isNumber ? 'phone' : 'email', redirectRoute: widget.redirectRoute);

                                      if(response != null && response.isSuccess) {
                                        RouterHelper.getVerifyRoute(FromPage.forget.name, userInput, redirectRoute: widget.redirectRoute);
