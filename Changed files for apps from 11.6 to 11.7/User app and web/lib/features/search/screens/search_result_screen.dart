...
import 'package:flutter_restaurant/features/search/widget/search_filter_widget.dart';
        ...
        Container(
          ...
          child: SafeArea(
            child: Row(children: [
              ...
              IconButton(
                onPressed: ()=> RouterHelper.forceGoToBack(context),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        child: Row(children: [
                          ...
                          IgnorePointer(
                            ...
                            child: FoodFilterButtonWidget(
                              isVegSelected: searchProvider.vegTagStatus,
                              isNonVegSelected: searchProvider.nonVegTagStatus,
                              isBorder: true,
                              onVegToggle: () {
                                searchProvider.onChangeVegTagStatus(status: !searchProvider.vegTagStatus);
                                searchProvider.searchProduct(name: _searchController.text, isUpdate: true, offset: 1, context: context);
                              },
                              onNonVegToggle: () {
                                searchProvider.onChangeNonVegTagStatus(status: !searchProvider.nonVegTagStatus);
                                searchProvider.searchProduct(name: _searchController.text, isUpdate: true, offset: 1, context: context);
                              },
                            ),
                          ),
                    ...
                    (searchProvider.searchProductModel?.products?.isNotEmpty ?? false) ?  Padding(
                      ...
                      child: PaginatedListWidget(
                        isDisableWebLoader: true,
                        scrollController: scrollController,
                        onPaginate: (int? offset) => searchProvider.searchProduct(name: _searchController.text, offset: offset ?? 1, context: context),
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveHelper.isDesktop(context) ? PopupMenuButton<dynamic>(
      ...
      itemBuilder: (BuildContext context) {
        ...
        Provider.of<SearchProvider>(context, listen: false).initTempFoodTypeStatus();
        return [
          PopupMenuItem(
            padding: EdgeInsets.zero,
            value: 'open_filter',
            child: SizedBox(height: heightSize * 0.7, width: double.maxFinite, child: SearchFilterWidget(maxValue: maxValue)),
          ),
        ];
      },
      ...
      onTap: () {
        ...
        showModalBottomSheet(
          ...
          builder: (ctx) => Container(
              ...
              child: SearchFilterWidget(maxValue: maxValue)),
        );
      },
      child: CustomAssetImageWidget(Images.filterSvg, width: 25, height: 25, color: Theme.of(context).primaryColor),
    ));
