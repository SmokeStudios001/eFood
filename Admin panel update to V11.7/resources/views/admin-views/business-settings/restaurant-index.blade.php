                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-between cmn_focus-shadow align-items-center border rounded mb-2 px-3 py-2">
                            <h5 class="mb-0 text-nowrap">{{translate('Maintenance Mode')}}</h5>
                                            ...
                                            <div class="text-center">
                                                <div class="upload-file_custom ratio-3-1 h-100px mx-auto">
                                                    ...
                                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                                        ...
                                                        <img class="upload-file-img" loading="lazy" src="{{asset('storage/app/public/restaurant/'.$logo)}}"
                                            ...
                                            <div class="text-center">
                                                <div class="upload-file_custom ratio-1 h-100px mx-auto">
                                                    ...
                                                    <label class="upload-file__wrapper w-100 h-100 m-0">
                                                        ...
                                                        <img class="upload-file-img" loading="lazy" src="{{asset('storage/app/public/restaurant/'.$fav_icon)}}"
                                                                data-default-src="" alt="" style="display: none;">
                                                    </label>
                                                    <div class="overlay-review">
                                                        <div
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file cmn_focus rounded">
                                                <input type="file" name="logo" id="customFileEg1" class="custom-file-input" tabindex="6"
                                                       accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*"
                                                       data-maxFileSize="{{ readableUploadMaxFileSize('image') }}">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file cmn_focus rounded">
                                                <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input" tabindex="7"
                                                       accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*"
                                                       data-maxFileSize="{{ readableUploadMaxFileSize('image') }}">
                                                <label class="custom-file-label"
