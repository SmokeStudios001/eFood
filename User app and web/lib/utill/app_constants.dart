import 'package:flutter_restaurant/common/enums/local_caches_type_enum.dart';
...
class AppConstants {
  ...
  static const String appVersion = '11.7'; /// Flutter SDK 3.38.5
  ...
  static const String websiteUrl =  'YOUR_DOMAIN_HERE'; // Replace with your actual web site URL : ex: https://efood-web.6amtech.com
  ...
  static const String placeDigitalOrder = '/api/v1/payment-mobile';
  ...
  static const String addFundWallet = '/api/v1/add-fund-wallet';
