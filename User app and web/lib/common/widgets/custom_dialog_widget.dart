...
void openDialog(Widget child, {bool isDismissible = true, bool isDialog = false, bool willPop = true}) {
  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) => PopScope(child: child, onPopInvokedWithResult: (bool didPop, dynamic result) => willPop),
    context: Get.context!,
  ) :
  showAnimatedDialog(
    Get.context!,
    Dialog(
      backgroundColor: Colors.transparent,
      child:   PopScope(child: child, onPopInvokedWithResult: (bool didPop, dynamic result) => willPop),
    ),
