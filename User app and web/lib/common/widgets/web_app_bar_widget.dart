...
class _WebAppBarWidgetState extends State<WebAppBarWidget> {
  ...
  Future<void> _showPopupMenu(Offset offset, BuildContext context, bool isCategory) async {
        ...
        Expanded(child: Center(child: SizedBox(width: Dimensions.webScreenWidth, child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          InkWell(
            onTap: (){
              ...
              final currentPage = GoRouter.of(context).routeInformationProvider.value.uri.queryParameters['page'];
              if(currentPath != RouterHelper.dashboardScreen || currentPage != 'favourite') {
          ...
          InkWell(
            onTap: (){
              final currentPath = GoRouter.of(context).routeInformationProvider.value.uri.path;
              final currentPage = GoRouter.of(context).routeInformationProvider.value.uri.queryParameters['page'];
              if(currentPath != RouterHelper.dashboardScreen || currentPage != 'cart') {
          ...
          OnHoverWidget(builder: (isHover)=> Padding(
            ...
            child: InkWell(
              onTap:(){
                if(GoRouter.of(context).routeInformationProvider.value.uri.path != RouterHelper.profileScreen) {
          ...
          OnHoverWidget(builder: (isHover)=> InkWell(
            onTap: (){
              final currentPath = GoRouter.of(context).routeInformationProvider.value.uri.path;
              final currentPage = GoRouter.of(context).routeInformationProvider.value.uri.queryParameters['page'];
              if(currentPath != RouterHelper.dashboardScreen || currentPage != 'menu') {
  ...
  bool _canRouteToHome(BuildContext context) => GoRouter.of(context).routeInformationProvider.value.uri.path != RouterHelper.dashboard && GoRouter.of(context).routeInformationProvider.value.uri.path != RouterHelper.homeScreen;
