...
class CustomAlertDialogWidget extends StatelessWidget {
  ...
  (image != null ? 1 : 0) +
      (icon != null ? 1 : 0) +
      (leadingIconWidget != null ? 1 : 0) <= 1,
  'Only one of image, icon, or leadingIconWidget can be provided',
  );
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Icon(Icons.clear_outlined, size: Dimensions.paddingSizeDefault,),
              ),
            ),
          ),
        ))),
