...
import 'package:flutter_restaurant/helper/auth_helper.dart';
...
class OptionsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isLoggedIn = Provider.of<AuthProvider>(context, listen: true).isLoggedIn();
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                PortionWidget(imageIcon: Images.trackOrder, title: getTranslated('track_order', context)!, onRoute:()=> RouterHelper.getOrderSearchScreen()),
              ...
              child: Column(children: [
                ...
                InkWell(
                  onTap: isLoggedIn
                      ...
                      : () => AuthHelper.handleLogin(context),
                  child: Padding(
