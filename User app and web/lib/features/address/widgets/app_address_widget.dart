...
class _AppAddressWidgetState extends State<AppAddressWidget> {
  ...
  void initState() {
    ...
    Provider.of<LocationProvider>(context, listen: false).setCameraPosition = null;
  }
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    GoogleMap(
                      ...
                      initialCameraPosition: CameraPosition(
                        target: _getTargetedLatLng(locationProvider),
                        zoom: 8,
                      ),
                      ...
                      onCameraMove: ((position) {
                        locationProvider.setCameraPosition = position;
                    ...
                    Positioned(top: 10, right: 0, child: InkWell(
                      onTap:() async {
                        final bool isPickedAddressAvailable = locationProvider.pickedAddressLongitude != widget.inputModel.address?.longitude && locationProvider.pickedAddressLatitude != widget.inputModel.address?.latitude;

                        await Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => SelectLocationScreen(googleMapController: controller, initialLocation: isPickedAddressAvailable ? null : widget.inputModel.address),
                        ));
  ...
  LatLng _getTargetedLatLng(LocationProvider locationProvider) {
    return widget.inputModel.isEnableUpdate
