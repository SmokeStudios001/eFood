...
class CreateAccountScreen extends StatefulWidget {
  const CreateAccountScreen({super.key, this.referralCode, this.redirectRoute});
...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  void initState() {
    ...
    if (config?.referEarnStatus == true && (widget.referralCode?.isNotEmpty ?? false)) {
                                ...
                                ? CustomButtonWidget(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (firstName.isEmpty) {
                                        ...
                                        await authProvider.registration(signUpModel, config, redirectRoute: widget.redirectRoute).then((status) async {
                                          if (status.isSuccess) {
