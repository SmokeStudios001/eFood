...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   if(configModel.customerLogin!.loginOption!.manualLogin == 0 && configModel.customerLogin!.loginOption!.otpLogin == 0) {
     return OnlySocialLoginWidget(redirectRoute: widget.redirectRoute);
   }
                      ...
                      builder: (context, authProvider, child) => Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            InkWell(
                              onTap: () {
                                RouterHelper.getForgetPassRoute(redirectRoute: widget.redirectRoute);
                              },
                              child: Padding(
                              ...
                              if (_emailPhoneController!.text.isEmpty) {
                                ...
                                await authProvider.login(userInput, password, type).then((status) async {
                                  if (status.isSuccess) {
                                    ...
                                    // Check if there's a redirect route, otherwise go to dashboard
                          ...
                          if(configModel.customerLogin?.loginOption?.otpLogin == 1) ...[
                            ...
                            InkWell(
                              ...
                              onTap: ()=> RouterHelper.getOtpVerificationScreen(redirectRoute: widget.redirectRoute),
                          ...
                          if((configModel.customerLogin?.loginOption?.socialMediaLogin == 1) && (socialStatus?.apple == 1 || socialStatus?.google == 1 || socialStatus?.facebook == 1))
                            Center(child: SocialLoginWidget(redirectRoute: widget.redirectRoute)),
                          const SizedBox(height: Dimensions.paddingSizeLarge),
     
                          InkWell(
                            onTap: ()=> RouterHelper.getCreateAccountRoute(redirectRoute: widget.redirectRoute),
                            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
