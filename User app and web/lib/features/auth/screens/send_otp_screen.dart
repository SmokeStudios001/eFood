...
class SendOtpScreen extends StatefulWidget {
  ...
  const SendOtpScreen({super.key, this.redirectRoute});
                                ...
                                onTap: () async {
                                  ...
                                  if (_phoneNumberController!.text.isEmpty) {
                                    ...
                                    if(configModel.customerVerification?.firebase == 1) {
                                      await authProvider.firebaseVerifyPhoneNumber(phoneWithCountryCode, redirectRoute: widget.redirectRoute);
                                    } else if(configModel.customerVerification?.phone == 1){
                                      await authProvider.checkPhoneForOtp(phoneWithCountryCode, redirectRoute: widget.redirectRoute);
                                    }
                                  }
