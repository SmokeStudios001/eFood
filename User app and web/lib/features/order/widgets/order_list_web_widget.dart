            ...
            child: Column(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Theme.of(context).tabBarTheme.indicatorColor?.withValues(alpha: 0.05),
                  border: Border.all(color: Theme.of(context).tabBarTheme.indicatorColor!.withValues(alpha: 0.1)),
