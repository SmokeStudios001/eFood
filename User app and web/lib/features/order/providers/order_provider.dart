...
class OrderProvider extends ChangeNotifier {
  ...
  Future<String?> placeDigitalOrder(BuildContext context, PlaceOrderBody placeOrderBody) async {
    _isLoading = true;
    notifyListeners();

    String? selectedUrl;
    ApiResponseModel apiResponse = await orderRepo!.placeDigitalOrder(
      placeOrderBody, guestId: Provider.of<AuthProvider>(Get.context!, listen: false).getGuestId(),
    );
