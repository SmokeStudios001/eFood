...
class OrderRepo {
  ...
  Future<ApiResponseModel> placeDigitalOrder(PlaceOrderBody orderBody,  {String? guestId}) async {
    ...
    try {
      ...
      final response = await dioClient!.post(AppConstants.placeDigitalOrder, data: data);
      return ApiResponseModel.withSuccess(response);
    } catch (e) {
      return ApiResponseModel.withError(ApiErrorHandler.getMessage(e));
    }
