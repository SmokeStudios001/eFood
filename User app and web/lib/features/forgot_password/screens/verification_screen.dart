...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen(
      ...
      this.session, this.redirectRoute});
                          ...
                          if (widget.fromPage == FromPage.login.name) {
                            ...
                            if(isPhone && isFirebaseOTP){
                              ...
                              authProvider.verifyPhoneForOtp(userInput).then((value){
                                ...
                                if((responseModel != null && responseModel.isSuccess) && tempToken == null) {
                                  ...
                                  RouterHelper.getOtpRegistrationScreen(tempToken, userInput, action: RouteAction.pushReplacement, redirectRoute: widget.redirectRoute);
                            ...
                            if (isFirebaseOTP && isPhone) {
                              ...
                              authProvider.verifyToken(userInput).then((value) {
                                if (value.isSuccess) {
                                  RouterHelper.getNewPassRoute(userInput, authProvider.verificationCode, redirectRoute: widget.redirectRoute);
                                } else {
                              ...
                              return CustomDirectionalityWidget(
                                child: Text(
                                  ...
                                  style: rubikSemiBold.copyWith(
                                    ...
                                    Theme.of(context).colorScheme.onSurface : Theme.of(context).tabBarTheme.indicatorColor,
                                  )),
                              );
