...
class InfiniteCarouselWidget extends StatefulWidget {
  ...
  ///
  /// Based on [ListWheelScrollView] to create smooth scroll effect and physics.
  InfiniteCarouselWidget.builder({
    super.key,
  ...
  /// Physics for [InfiniteCarouselWidget]. Defaults to [InfiniteScrollPhysics], which makes sure we always land on a
  /// particular item after scrolling.
  final ScrollPhysics? physics;

  /// Scroll behavior for [InfiniteCarouselWidget].
...
/// Scroll controller for [InfiniteCarouselWidget].
...
/// Physics for [InfiniteCarouselWidget].
///
