          ...
          builder: (context, checkoutProvider, child) {
            return Consumer<CartProvider>(
              builder: (context, cart, child) {
                ...
                double orderAmountAfterDiscount = orderAmount - discount;

                double referralDiscount = CheckOutHelper.getReferralDiscount(
                  totalAmount: orderAmountAfterDiscount , referralDetails: profileProvider.userInfoModel?.referralCustomerDetails,
                );

                double amountAfterDiscount = orderAmountAfterDiscount - referralDiscount;
