                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Consumer<CartProvider>(
                            ...
                            return InkWell(
                              onTap: () {
                                final int cartIndex =  cartProvider.getLastUpdatedCartIndex(setMenu.setMenuList![index]);

                                ProductHelper.addToCart(cartIndex: cartIndex, product: setMenu.setMenuList![index]);
