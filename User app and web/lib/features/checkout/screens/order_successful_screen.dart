    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<OrderProvider>(
            ...
            return Skeletonizer(
              enabled: orderProvider.trackModel == null && widget.status == 0,
              child: orderProvider.trackModel?.id == -1 && widget.status == 0 ? NoDataWidget() :  ResponsiveHelper.isWeb() ? CustomScrollView(
                slivers: [
