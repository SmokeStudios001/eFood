...
class _OfflinePaymentWidgetState extends State<OfflinePaymentWidget> {
  ...
  void initState() {
    ...
    checkoutProvider.changePaymentMethod(offlinePaymentModel: widget.selectedOfflineMethod, isUpdate: false);
                ...
                child: IntrinsicHeight(
                  child: Row(children: splashProvider.offlinePaymentModelList!.map((offline) => AutoScrollTag(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        width: ResponsiveHelper.isMobile() ? MediaQuery.sizeOf(context).width * 0.8 : 320,
